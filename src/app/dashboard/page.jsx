  ...
  return (
    <div className='p-2.5 pt-4 md:pt-10 max-w-screen-3xl h-fu w-full m-auto flex flex-col min-w-80 z-10 text-white'>
      ...
      <div className='relative w-full'>
        <div className='flex justify-center absolute m-auto left-0 top-0 w-full'>
          {showLoader && (
            <RotatingLines
              height='28'
              width='28'
      ...
      <div className='grid grid-cols-2 gap-x-4 items-center md:px-5 mx-0 md:mx-5 mb-2 relative'>
      ...
      <div className='grid grid-col-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 px-0 md:px-10 py-3 gap-4 md:gap-6'>
        {allJobs?.map((job) => (
