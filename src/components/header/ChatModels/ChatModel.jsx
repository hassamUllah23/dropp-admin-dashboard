...
const ChatModel = () => {
  ...
  const [selectedOption, setSelectedOption] = useState('Mixtral');
  ...
  return (
    <div className="w-full py-1 flex items-center justify-between flex-wrap relative">
      <p className="pt-2 py-1 text-white/80 pb-3 text-sm">Text</p>
      <div className="relative inline-block">
        ...
        {isOpen && (
          <ul className="absolute bg-black w-40 border border-gray-150 py-1 mt-1 rounded-lg text-xs">
            <li onClick={() => handleOptionClick('mixtral', 'Mixtral')} className="cursor-pointer px-3 py-1 hover:bg-gray-100">
              Mixtral
            </li>
            <li onClick={() => handleOptionClick('openai', 'Openai')} className="cursor-pointer px-3 py-1 hover:bg-gray-100">
              Openai
            </li>
            <li onClick={() => handleOptionClick('llama', 'Llama')} className="cursor-pointer px-3 py-1 hover:bg-gray-100">
              Llama
            </li>
          </ul>
        )}
