...
const DigitalHuman = () => {
  ...
  return (
    <div className="w-full py-1 flex items-center justify-between flex-wrap relative">
      <p className="pt-2 py-1 text-white/80 pb-3 text-sm">Digital Human</p>
      <div className="relative inline-block">
        ...
        {isOpen && (
          <ul className="absolute bg-black w-40 border border-gray-150 py-1 mt-1 rounded-lg text-xs">
            <li onClick={() => handleOptionClick('elevenlabs', 'Eleven labs')} className="cursor-pointer px-3 py-1 hover:bg-gray-100">
            Eleven labs
            </li>
            <li onClick={() => handleOptionClick('tts-clone','Tts clone')} className="cursor-pointer px-3 py-1 hover:bg-gray-100">
            Tts clone
            </li>
          </ul>
        )}
