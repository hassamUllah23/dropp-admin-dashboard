      ...
      <div className="relative inline-block">
        ...
        {isOpen && (
          <ul className="absolute bg-black w-40 border border-gray-150 py-1 mt-1 rounded-lg text-xs">
            <li onClick={() => handleOptionClick('shap_e', 'Shap e')} className="cursor-pointer px-3 py-1 hover:bg-gray-100">
              Shap e
            </li>
            <li onClick={() => handleOptionClick('dreamgaussian', 'Dream Gaussian')} className="cursor-pointer px-3 py-1 hover:bg-gray-100">
              Dream Gaussian
            </li>
            <li onClick={() => handleOptionClick('open_lrm', 'Open Lrm')} className="cursor-pointer px-3 py-1 hover:bg-gray-100">
              Open Lrm
            </li>
          </ul>
        )}
