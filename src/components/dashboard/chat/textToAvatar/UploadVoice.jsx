...
export default function UploadVoice({ onUploadVoice }) {
  ...
  const handleFiles = (files) => {
    for (let i = 0; i < files.length; i++) {
      ...
      reader.onload = async (e) => {
        const audioBlob = new Blob([e.target.result], { type: 'audio/mp3' }); // Adjust the type as needed
        ...
        audio.onloadedmetadata = () => {
          ...
          onUploadVoice(files[0]);

          // Additional logic for handling audio file upload

          // const result = await handleChatApiCall({
          //   method: 'POST',
          //   url: '/audio/upload',
          //   data: audioDataURL,
      ...
      <div>
        <div className=' flex space-x-2'>
          ...
          <div className='w-full flex-1'>
            <p className='pb-3 text-xs md:text-base'>Ok Great! Now Upload your Voice</p>
            <div className=' p-6 relative bg-no-repeat bg-cover bgGrayImage rounded-2xl'>
              {showUploader && (
                <div
