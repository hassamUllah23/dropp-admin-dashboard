    ...
    <div className='lightGrayBg absolute text-white py-2 px-4 rounded-2xl top-8 right-2 flex flex-col text-sm font-normal w-40 cursor-pointer '>
        <div className='flex items-center py-2 group'>
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-white group-hover:text-[#F04141]">
                <path d="M10.3866 7.99999C10.3866 9.31999 9.31995 10.3867 7.99995 10.3867C6.67995 10.3867 5.61328 9.31999 5.61328 7.99999C5.61328 6.67999 6.67995 5.61333 7.99995 5.61333C9.31995 5.61333 10.3866 6.67999 10.3866 7.99999Z" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"/>
        ...
        <div className='flex items-center py-2'>
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-white">
                <path d="M14 3.98667C11.78 3.76667 9.54667 3.65334 7.32 3.65334C6 3.65334 4.68 3.72 3.36 3.85334L2 3.98667" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"/>
                <path d="M5.6665 3.31334L5.81317 2.44C5.91984 1.80667 5.99984 1.33334 7.1265 1.33334H8.87317C9.99984 1.33334 10.0865 1.83334 10.1865 2.44667L10.3332 3.31334" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"/>
                <path d="M12.5664 6.09333L12.1331 12.8067C12.0598 13.8533 11.9998 14.6667 10.1398 14.6667H5.85977C3.99977 14.6667 3.93977 13.8533 3.86644 12.8067L3.43311 6.09333" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"/>
                <path d="M6.88672 11H9.10672" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"/>
                <path d="M6.3335 8.33334H9.66683" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
